...
void PlayScene::start()
{
	...
	m_pSpaceShip->setRotation(atan2(m_pTarget->getTransform()->position.x - m_pSpaceShip->getTransform()->position.x,
		m_pSpaceShip->getTransform()->position.y - m_pTarget->getTransform()->position.y) * (180 / 3.141595));
